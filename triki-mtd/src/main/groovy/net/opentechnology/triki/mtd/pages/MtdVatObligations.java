...
public class MtdVatObligations extends MtdVatManage {
  ...
  private class MtdVatObligationsForm extends Form {
    ...
    public MtdVatObligationsForm(String id, SessionUtils sessionUtils) {
      ...
      vrnFeedback.setFilter(new ComponentFeedbackMessageFilter(vrnFeedback));
      add(vrnFeedback);
...
//      HiddenField dateRange = new HiddenField("dateRange");
//      add(dateRange);
//      HiddenField status = new HiddenField("status");
//      add(status);
