...
import net.opentechnology.triki.mtd.vat.async.VatSubmissionRoute
import net.opentechnology.triki.mtd.vat.security.HmrcIdentityProvider
import net.opentechnology.triki.mtd.vat.wicket.MtdVatApplication
...
public class HmrcVatModule implements Module {
	...
	@Inject
	private VatSubmissionRoute vatSubmissionRoute;
	...
	private void initTemplates() throws StartupException {
		try {
			templateStore.addTemplate("mtdvat.stg");
